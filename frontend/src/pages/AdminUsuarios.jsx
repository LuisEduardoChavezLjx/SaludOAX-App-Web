...
export default function AdminUsuarios() {
  ...
  const isMismoAdmin = (usuario) => usuario.email === 'admin@saludoax.com'
        ...
        <section className="col-span-8 rounded-xl border border-line bg-white min-w-0">
          ...
          {usuarios.content.length === 0 ? (
            ...
            <>
              ...
              <Pagination page={usuarios.page} totalPages={usuarios.totalPages} totalElements={usuarios.totalElements} onPageChange={setPage} />
            </>
          )}
        </section>
