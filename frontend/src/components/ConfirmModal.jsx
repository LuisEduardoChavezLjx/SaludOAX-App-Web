      ...
      >
        ...
        <div className="px-6 py-4 border-t border-line flex justify-end gap-3">
          <button
            ...
            onClick={onCancel}
            disabled={loading}
            className="rounded-lg border border-line bg-white px-4 py-2.5 text-sm font-semibold text-muted transition-colors duration-150 hover:bg-subtle hover:text-ink active:scale-[0.97]"
          >
            Cancelar
          </button>
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className={`rounded-lg px-4 py-2.5 text-sm font-semibold text-white transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 active:scale-[0.97] disabled:opacity-50 disabled:active:scale-100 ${botonConfirmar}`}
          >
